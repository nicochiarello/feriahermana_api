...
exports.verify = async (req,res) => {
  ...
  try {
    ...
    const paymentStatus = axios.get(`https://api.mercadopago.com/v1/payments/${id}`, {Authorization:"Bearer APP_USR-4118311813066874-032322-c78f760dfd1e2490d6aeb2776d239e93-659536649"});
